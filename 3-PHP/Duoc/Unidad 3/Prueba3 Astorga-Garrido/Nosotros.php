<!DOCTYPE html>
  <html lang="es">
     ...
     <head>
    	  ...
    	  <title>Nosotros | CRM</title>
		  
		  <meta http-equiv="content-Type" content="text/html; charset=utf-8" />
		 
		  <link rel="stylesheet" href="css2/Menu.css">
		  <link rel="stylesheet" href="css2/PaginaNosotros.css">
     ...
     <body background="fotos/fondo.jpg">
         ...
         <section>
		     ...
		     <center><p>NOSOTROS</p></center><br>
			 <hr>
			 <center><p>Llegamos a la zona a principios el año 2006,<br>
			 procedentes de la comuna de San Bernardo<br> 
			 de Santiago,  optamos por este lugar después de visitar <br>
			 muchos otros, con la finalidad de vivir y construir nuestro<br>
			 proyecto, sueno de mucho tiempo, que<br>
			 por fin hoy vemos hecho realidad.<br>
			 <br>
             A principios del 2007, ya contábamos con el camping,<br> 
			 con capacidad para 20 sitios, sus respectivos <br>
			 baños, duchas con agua caliente, lavaderos y lavaplatos.<br>
			 <br>
             Actualmente nuestra capacidad a aumentado <br>
			 y además contamos con un pequeño 
			 minimarket.</p><br> </center>
			  <br>
			 <center><b>"Camping Rio Maule, es lugar privilegiado, ubicado en la ribera<br>
              del río Maule, rodeado por bosques de aromos y a solo<br>
              15 minutos del centro de la ciudad."</b><center>
         </section>
		 <br>
		 <aside>
		 <IMG src="fotos/nosotros.jpg" width=450 height=550px align=center>
		 </aside>
