...
<body background="Imagenes/principal.jpg" style="background-attachment: fixed" >
...
<form method="post" action="" >
  <fieldset>
    ...
    <div class="form-group">
      ...
      <input type="text" name="realname" class="form-control" pattern="([a-zA-ZñÑáéíóúÁÉÍÓÚüÜ ']{3,25})" placeholder="Ingresa tu nombre" />
    </div>
    <div class="form-group">
