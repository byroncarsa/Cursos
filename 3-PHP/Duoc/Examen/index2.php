  ...
  <html lang="es">
       ...
       <body background="Imagenes/Fondos.jpg" >
         ...
         <section>
              ...
              <script>
               ...
               <div data-p="112.50" style="display: none;">
                  <img data-u="image" src="Imagenes/Slider1.jpg" />
                  <div data-u="caption" data-t="3" style="position: absolute; top: 30px; left: 30px; width: 350px; height: 30px; background-color: #5B9279; font-size: 20px; color: #ffffff; line-height: 30px; text-align: center;">Aprende Java</div>
               </div>
			
               <div data-p="112.50" style="display: none;">
                  <img data-u="image" src="Imagenes/Slider2.jpg" />
                  <div data-u="caption" data-t="3" style="position: absolute; top: 30px; left: 30px; width: 350px; height: 30px; background-color: #5B9279; font-size: 20px; color: #ffffff; line-height: 30px; text-align: center;">Aprende .Net</div>
               </div>
			
               <div data-p="112.50" style="display: none;">
                  <img data-u="image" src="Imagenes/Slider3.png" />
                  <div data-u="caption" data-t="3" style="position: absolute; top: 30px; left: 30px; width: 350px; height: 30px; background-color: #5B9279; font-size: 20px; color: #ffffff; line-height: 30px; text-align: center;">Aprende PHP</div>
               </div>
		 ...
		 <aside>
			 ...
			 de aprendizaje. <br>
			 <br>
			 En la area de mayor <br>
			 crecimiento en la actualidad.<br> 
			 <br>
			 Aprende con nosotros a  <br>
			 programar y desarrollar.</p></center>
			 <br>
		 </aside>
